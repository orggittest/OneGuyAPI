...
class Category(YGBaseModel):
    ...
    parent = models.ForeignKey('self', on_delete=models.CASCADE, verbose_name='父类', null=True, blank=True)
    picture_url = models.CharField(max_length=200, verbose_name='图片地址', blank=True, null=True)
